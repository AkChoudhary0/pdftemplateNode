            ...
            <tr>
                <td>
                    ...
                    <table style="width: 100%; padding: 0px 25px;">
                        <tr>
                            <td>
                                <p><img src="/images/plane-taking-off.png" width="40px" height="30px" alt="departure">{{source}} - {{destination}}</p>
                            </td>
                        </tr>
                        <tr>
            ...
            <tr>
                <td>
                    ...
                    <table style="width: 95%; margin: 10px 25px; border: 1px solid  ;">
                        <!-- Guest Info -->
                        <tr style="margin-top:20px;">
                            <td><img src="./controllers/user/image/Vector.png" width="30px" height="20px" style="margin-right: 10px;"  alt="airport">New Delhi <img width="20px" height="20px" style="margin:0px 10px; opacity: 0.5;" src="/images/exchange.png"  alt="airport"> Duba</td>
                            <td style="width: 40%;">
                                <p
                    ...
                    <table style="width: 100%; padding: 0px 25px;border-bottom: 1px solid;">
                        ...
                        <tr style="margin-top:20px;">
                            <td>
                                <p><img src="/images/traveler-with-a-suitcase.png" width="30px" /><br/><strong>{{name}}</strong></p>
                            </td>
                            <td style="width: 40%;">
